...
where
    _table_suffix between '20210101' and '20220627'
...
where
    ...
    and platform = 'WEB'
    and _table_suffix between '20210101' and '20220627'
...
'search listing => addToCart' type_funnel,
count(distinct k1.id) search,
count(distinct k2.id) conversion,
...
-- search listing => karta produktu (exact match)
