...
where
    ...
    and regexp_extract(_table_suffix, '[0-9]+') between '20220928' and format_date('%Y%m%d', current_date())
...
v2.item_id item_id_add_to_cart,
...
from view_item_list v1 left join add_to_cart v2 on v1.true_date=v2.true_date and v1.device=v2.device and v1.id=v2.id and v1.item_list_name=v2.item_list_name
